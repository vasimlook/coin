                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-6">
                                    <div class="stat-box">
                                        ...
                                        <h2 class="text-neon"><?php echo ($level_1_user_count != '') ? $level_1_user_count : 0; ?></h2>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="stat-box">
                                        <span>Level 2 Members</span>
                                        <h2 class="text-neon"><?php echo ($level_2_user_count != '') ? $level_2_user_count : 0; ?></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="bet-card p-4">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <p class="mb-1 text-info">📞 <?php echo str_repeat('*', strlen($value['phone']) - 5) . substr($value['phone'], -5); ?></p>
                                                </div>
