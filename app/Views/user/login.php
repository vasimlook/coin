                    ...
                    <div class="nk-block nk-block-middle nk-auth-body wide-xs pt-0">
                        ...
                        <div class="card card-bordered rounded-5">
                            <div class="card-inner card-inner-lg">
                                ...
                                echo form_open(USER_LOGIN_LINK, $attributes);
                                ?>
                                <div class="form-group mb-2">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control form-control-lg" maxlength="10" minlength="10" id="username" name="username" placeholder="Enter your mobile no" required="" autocomplete="off">
                                ...
                                <?php echo form_close(); ?>
                                <div class="form-label-group mt-3 justify-content-center">
                                    <a class="link link-light link-sm" href="<?php echo USER_FORGET_PWD_LINK; ?>">Forgot Password?</a>
                                </div>
                                <div class="custom-divider"><span>Or</span></div>
                                <div class="form-note-s2">
                                    <a class="btn btn-lg btn-primary-outline btn-block" href="<?php echo USER_SIGNUP_LINK.REGISTER_CODE; ?>"><em class="icon ni ni-user"></em>&nbsp;&nbsp;Sign up</a>
                                </div>
                            </div>
                        </div>
                    </div>
