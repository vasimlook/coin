                        ...
                        <div class="card card-bordered">
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-white">
                                            <p>One step away to recover your account.</p>
                                        </div>
                                    </div>
                                </div>
                                <?php 
                                    $attributes = ['id' => 'otp_verify', 'name' => 'otp_verify'];                                                                         
                                    echo form_open(USER_PWD_OTP_LINK.$mono,$attributes);
                                ?> 
                                ...
                                <div class="form-note-s2 text-center">
                                    <a href="<?php echo USER_LOGIN_LINK; ?>" class="text-primary"><strong>Return to login</strong></a>
                                </div>
                            </div>
                        </div>
                    </div>                    
